...
struct Export {
    ...
    static func saveResult(_ results: [(Iteration, TimeInterval)], for startDate: Date, threads: Int) {
        ...
        let report = [
            ...
            "- probability IndepA_B = \(Tree.probabilityIndepA_B)",
            "- probability IndepC_B = \(Tree.probabilityIndepC_B)",
            "- probability IndepC_A = \(Tree.probabilityIndepC_A)",
            "- probability IndepC_AB = \(Tree.probabilityIndepC_AB)",
